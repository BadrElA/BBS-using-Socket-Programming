...
Deployment guidance for `BadrElA/BBS-using-Socket-Programming`.

> Only verified or clearly labeled information is included. Unsupported steps are marked unknown.
...
- ARTI documentation generation does **not** perform deployments.
